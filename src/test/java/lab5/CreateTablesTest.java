...
public class CreateTablesTest {
    ...
    public void createTables() {
        try {
            sqlExecutor.executeQueryWithNoResult("DROP TABLE IF EXISTS lab.championship_has_position;");
            ...
            sqlExecutor.executeQueryWithNoResult("CREATE TABLE championship_has_position(\n" +
                    ...
                    "PRIMARY KEY (`championship_id`, `position_id`),\n"+
//                    "INDEX `fk_championship_has_position_position1_idx` (`position_id` ASC) VISIBLE,\n"+
...
//                    "CONSTRAINT `fk_championship_has_position_championship1`\n"+
                    ...
                    "REFERENCES `lab`.`championship` (`id`)\n"+
                    "ON DELETE NO ACTION\n"+
                    "ON UPDATE NO ACTION,\n"+
                    //"CONSTRAINT `fk_championship_has_position_position1`\n"+
                    "FOREIGN KEY (`position_id`)\n"+
                    "REFERENCES `lab`.`position` (`id`)\n"+
                    "ON DELETE NO ACTION\n"+
                    "ON UPDATE NO ACTION\n"+
                    ");");
